...
export default function AvatarTutorIA({
  ...
  const speak = useCallback((value: string) => {
    ...
    utter.onstart = () => {
      ...
      const vid = videoRef.current;
      if (vid) { vid.currentTime = 0; vid.playbackRate = 0.62; vid.play().catch(() => {}); }
    };
    ...
    utter.onboundary = (e: SpeechSynthesisEvent) => {
      ...
      setTimeout(() => { if (videoRef.current) videoRef.current.playbackRate = 0.62; }, 130);
    };
